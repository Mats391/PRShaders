...
//	return float4(1,1,0,1);
...
#if _FORCE_1_3_SHADERS_
	float4 accumlights = tex2D(LightMapSampler, VsOut.lightTex);
#else
	...
	color.rgb *= light.xyz * tex2D(DetailMapSampler, VsOut.Tex1).rgb;
...
technique defaultTechnique
{
	pass P0
	{
		...
		pixelShader	= compile LOWPSMODEL basicPixelShader();
